...
def test_segment_end_before_start_raises() -> None:
    from models.transcript import Segment
...
def test_segment_equal_start_end_raises() -> None:
    from models.transcript import Segment
...
def test_transcript_creation() -> None:
...
def test_ad_segment_valid() -> None:
...
def test_ad_segment_confidence_out_of_range() -> None:
    from models.ad_segment import AdSegment
...
def test_ad_segment_confidence_negative() -> None:
    from models.ad_segment import AdSegment
...
def test_ad_segment_end_before_start_raises() -> None:
    from models.ad_segment import AdSegment
...
def test_ad_segment_equal_timestamps_raises() -> None:
    from models.ad_segment import AdSegment
...
def test_topic_context_creation() -> None:
